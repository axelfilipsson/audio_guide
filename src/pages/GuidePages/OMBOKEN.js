...
const GuidePage = (props) => {
  return (
    <Body>
      ...
      <InfoBox  setPopup={props.setPopup}  popup={props.popup}  firstWord={"För "} rest={"att få veta mer om Dramatenhuset och dess konst och inredning finns boken"}  italic={" 100 år på Nybroplan "} end={"utgiven strax innan Dramaten fyllde 100 år. Boken är skriven av berättaren ni lyssnat på, Dag Kronlund."} bold={"Boken finns att köpa i biljettkassan!"} />
      {
